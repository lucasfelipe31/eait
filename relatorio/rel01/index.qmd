...
resistencia25 <- read.csv2(
  "C:/Relatorios/eait/relatorio/rel01/resistencia25.csv",
  dec = ","
)
...
# Melhorando a apresentação das classes
tabela$Classes <- gsub(
  " \\|--- ",
  " – ",
  tabela$Classes
...
# Substituindo ponto decimal por vírgula nas classes
tabela$Classes <- gsub(
  "\\.",
  ",",
  tabela$Classes
...
A Tabela apresenta a distribuição de frequência dos valores de resistência à compressão dos corpos de prova. Os dados foram agrupados em cinco classes, permitindo observar a concentração das observações, a frequência absoluta e relativa e as frequências acumuladas.
