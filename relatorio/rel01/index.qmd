...
- Compreender os principais fundamentos do ambiente R e da linguagem utilizada para manipulação e análise de dados,  baseado no livro de Batista e Oliveira @Rbasico2022 e nas 26 vídeo-aulas do curso R Básico 2024;
...
O primeiro capítulo do livro Estatística & Probabilidade aplicada às Engenharias e Ciências 
(EPAEC) [@batista2024estatistica], apresenta a Estatística como uma área importante para a coleta, organização, análise e interpretação de dados. Seu objetivo é transformar informações em resultados que possam auxiliar na compreensão de situações e na tomada de decisões.
